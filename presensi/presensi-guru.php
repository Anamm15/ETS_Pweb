        ...
        <table class="kelas__tabel" cellpadding="20" cellspacing="50">
            ...
            <?php foreach ($kelas as $index => $row): ?>
                <tr>
                    ...
                    <td>
                        <a href="detail_presensi_guru.php?id=<?php echo $row['kelas_mapel_id']; ?>"><?php echo $row['mapel']; ?></a>
                    </td>
                    <td>
                        <a href="detail_presensi_guru.php?id=<?php echo $row['kelas_mapel_id']; ?>"><?php echo $row['kelas']; ?></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
